    ...
    tables: [
      ...
      table(
        ...
        [
          ...
          datetime("occurredAt"),
          varchar("origin", 16, { required: false }),
          varchar("providerLinkId", 36, { required: false }),
          varchar("provider", 16, { required: false }),
          varchar("repositoryId", 100, { required: false }),
          varchar("providerIssueId", 100, { required: false }),
          varchar("providerCommentId", 128, { required: false }),
          varchar("providerEventId", 128, { required: false }),
          text("providerAuthorEnvelope", { required: false }),
          varchar("revisionKind", 16, { required: false }),
          varchar("supersedesMessageId", 36, { required: false }),
          datetime("providerUpdatedAt", { required: false }),
        ],
        [
          index("feedback_time", ["feedbackId", "occurredAt"]),
          index("workspace_project", ["workspaceId", "projectId"]),
          index("provider_comment_time", [
            "provider",
            "repositoryId",
            "providerCommentId",
            "providerUpdatedAt",
          ]),
          index("provider_origin_time", ["origin", "providerUpdatedAt"]),
        ],
      ),
      table(
      ...
      table(
        ...
        [
          ...
          varchar("providerState", 16, { required: false }),
          datetime("providerUpdatedAt", { required: false }),
          varchar("lastProviderDeliveryId", 128, { required: false }),
          varchar("actorId", 36),
          datetime("createdAt"),
          datetime("updatedAt"),
        ],
      ...
      table(
        ...
        [
          integer("version"),
          varchar("environment", 16),
          varchar("aggregateKind", 32),
          varchar("aggregateId", 36),
          varchar("operationId", 36),
          varchar("commandKind", 64),
          varchar("workspaceId", 36),
          varchar("projectId", 36),
          varchar("actorKind", 16),
          varchar("actorId", 36),
