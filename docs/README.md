...
This directory defines Y7 Feedback through architecture and delivery planning.
...
9. [One-Week Sprint Plan](./09_ONE_WEEK_SPRINT_PLAN.md) - complete documented
   scope, daily phases, traceable tasks, gates, and verification evidence.
...
- In-product and email notifications are required capabilities when the recipient has
  an eligible channel.
- `bug`, `suggestion`, and `review` are the initial structured feedback types.
- Product Intelligence is a required capability built from preserved source data,
...
- Public, Reporter, and workspace experiences support French and English.
